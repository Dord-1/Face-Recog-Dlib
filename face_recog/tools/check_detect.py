"""Kiểm tra và dọn ảnh trùng / ảnh lỗi trong thư mục detect/ (chạy: python Check_Detect.py)."""
import argparse
import os

import face_recognition

from face_recog.config import DETECT_DIR, DUPLICATE_THRESHOLD
from face_recog.geometry import face_area, largest_face
from face_recog.known_faces import list_image_files
...
def scan_folder(folder):
    ...
    for name in list_image_files(folder):
        ...
        largest = largest_face(locations)
